...
do
{
    ...
    if (b == 1)
    {
        ...
        if (t < 16)
        {
            Console.WriteLine(D(6) * level + $" fire damage to all within 5 feet, Reflex save for half damage (DC = {10 + level})");
        }
        if (t > 15 && t < 20)
        {
            Console.WriteLine($"Missile deals {D(4) + level} points of damage, Relfex save for half damage (DC = {10 + level})");
        }
        if (t > 20)
        {
            int g = D(6) + CR;
            if (g < 3)
            {
                ...
                Console.WriteLine($"Fort DC 15, if fail take {D(4)} point of temp Con damage. If a second inhaling is done before recovering and failing the save, take {D(6)} points of Temp Con Damage");
            }
            if (g > 2 && g < 5)
            {
                Console.WriteLine("Rancid Gas");
                Console.WriteLine($"Fort DC 12, if fail take 1 point of temp Con damage. If a second inhaling is done before recovering and failing the save, take {D(6)} points of Temp Con Damage");
            }
            if (g > 4)
            {
                Console.WriteLine("Stangling Gas");
                Console.WriteLine($"Fort DC 18, if fail take {D(4) + D(4)} points of temp Con damage. If a second inhaling is done before recovering and failing the save, take {D(4) + D(4)} points of Temp Con Damage");
            }
    ...
    if (b > 12 && b < 18)
    {
        Console.WriteLine($"{D(20) * CR + level * 25} Gold");
    }
    if (b > 17)
    {
        //Item -------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (i > 15 && i < 18)
        {
            tre =Item(D(100), "Prefix");
        }
        if (i > 17 && i < 20)
        {
            tre = Item(D(100), "Suffix");
        }
        if (i > 19)
        {
            tre = Item(D(100), "PrefixNSuffix");
        }
    ...
    if (91 <= i && i <= 100)
    {
        ...
        else if (p <= 100)
        {
            if (q == "perishable")
            {
                item get1 = new item();
                item get2 = new item();
                get1 = Item(99, "perishable");
                get2 = Item(99, "perishable");
